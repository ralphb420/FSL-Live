...
FSL-Live is an open-source project focused on detecting and interpreting Filipino Sign Language gestures using machine learning. The system leverages the powerful TensorFlow framework to train and deploy a deep neural network model capable of recognizing various predefined actions.
